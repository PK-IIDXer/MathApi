  ...
  protected override void OnModelCreating(ModelBuilder modelBuilder)
  {
    ...
    modelBuilder.Entity<Inference>(
      nestedBuilder => {
        ...
        nestedBuilder.Navigation(i => i.Conclusion).AutoInclude();
    ...
    modelBuilder.Entity<InferenceArgument>(
      nestedBuilder => {
        ...
        nestedBuilder.HasOne(ia => ia.FormulaLabel)
                     .WithMany(fl => fl.InferenceArguments)
                     .HasPrincipalKey(fl => new { fl.Id })
                     .HasForeignKey(ia => new { ia.FormulaLabelId });
    ...
    modelBuilder.Entity<InferenceArgumentConstraint>(
      nestedBuilder => {
        ...
        nestedBuilder.HasOne(iac => iac.AssumptionForConstraintToAllPredissolvedAssumption)
                     .WithMany(ia => ia.InferenceArgumentConstraintForConstraintToAllPredissolvedAssumptions)
                     .HasPrincipalKey(ia => new { ia.InferenceId, ia.SerialNo })
                     .HasForeignKey(iac => new { iac.InferenceId, iac.AssumptionSerialNoForConstraintToAllPredissolvedAssumption });
      }
    );
    ...
    modelBuilder.Entity<InferenceConclusion>(
      nestedBuilder => {
        ...
        nestedBuilder.HasOne(ic => ic.Inference)
                     .WithOne(i => i.Conclusion)
                     .HasPrincipalKey<Inference>(i => new { i.Id })
                     .HasForeignKey<InferenceConclusion>(ic => new { ic.InferenceId });
    ...
    modelBuilder.Entity<InferenceFormulaStructArgumentMapping>(
      nestedBuilder => {
        nestedBuilder.HasKey(ifsam => new { ifsam.InferenceId, ifsam.SerialNo, ifsam.FormulaStructId, ifsam.FormulaStructArgumentSerialNo });
